...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    public static final String EXTRA_ITEM = "com.example.mymoviebi.EXTRA_ITEM";
    public static final String UPDATE_WIDGET = "com.example.mymoviebi.UPDATE_WIDGET";
    private static final String TOAST_ACTION = "com.example.mymoviebi.TOAST_ACTION";
